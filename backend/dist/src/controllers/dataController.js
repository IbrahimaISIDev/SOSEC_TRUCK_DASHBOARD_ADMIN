...
exports.getCamionsFromFirebase = exports.getUsersFromFirebase = exports.getMileagesFromFirebase = exports.getExpensesFromFirebase = exports.getTicketsFromFirebase = exports.getAllDataHandler = void 0;
...
const getCamionsFromFirebase = async (req, res) => {
    try {
        ...
        logger_1.default.error(`Erreur lors de la récupération des camions depuis Firebase: ${error.message}`);
        res.status(500).json({ error: error.message });
    }
};
exports.getCamionsFromFirebase = getCamionsFromFirebase;
